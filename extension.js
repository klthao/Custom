		...
		bot.commands.triviaCommand = {
			...
			functionality: function (chat, cmd) {
				...
				if (!bot.commands.executable(this.rank, chat)) return void (0);
					...
					var timeLimit = "You have 30 seconds to answer!";
					
					switch (randomInt) {
						case 1:
							API.sendChat(timeLimit + "\tWho was the lead singer of the band Audioslave");
							//Chris Cornell
							break;
						case 2:
							API.sendChat(timeLimit + "\tWhich pop star sang the national anthem at the 50th Super Bowl?");
							//Lady Gaga
							break;
						case 3:
							API.sendChat(timeLimit + "\nWho was the lead singer of the rock band Queen?");
							//Freddie Mercury
							break;
						case 4:
							API.sendChat(timeLimit + "\tABBA was a pop group from what country?");
							//Sweden
							break;
						case 5:
							API.sendChat(timeLimit + "\tHallelujah is a song written by which Canadian recording artist?");
							//Leonard Cohen
							break;
					}
				}
